...
export default function AddAssignment() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await api.teacher.add({ title, description, department, year, level, subject, dueDate });
      navigate("/teacher");
    } catch (err) {
      alert(err.message);
    } finally {
    ...
    <div style={{ minHeight: "100vh", background: "#f8f9fa", fontFamily: "'Inter', sans-serif" }}>
      <div style={{ background: "#fff", borderBottom: "1px solid #e9ecef", padding: "12px 0" }}>
        <div className="container d-flex justify-content-between align-items-center">
          <div>
            <h5 style={{ fontWeight: 700, margin: 0, color: "#212529" }}>Add Assignment</h5>
